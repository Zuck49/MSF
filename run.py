...
_____ListID_______ = [
    "100039177390395,","100039177390395","100039177390395"]
_____Post_______= [
    "700297481286159","700297481286159"]
...
{H} ____    ____   ______   ________  • By Niki Gagal tenaar •
|_   \  /   _|.' ____ \ |_   __  | • USER FREE•RASA PREMIUM•
...
def _____bot________():
	...
	______kom______ = ('Halo Bang Tenar  SC Lu GG Bang') 
